      ...
      <div className="flex flex-1 items-center justify-center p-4 md:p-6 bg-background overflow-hidden">
        <div className="w-full max-w-sm space-y-2 py-2">
          <div className="space-y-0.5">
            <h2 className="text-lg font-bold tracking-tight">Sign in to your account</h2>
            <p className="text-xs text-muted-foreground font-medium">Welcome back! Please enter your details.</p>
          </div>
          <LoginForm />
        </div>
      </div>
